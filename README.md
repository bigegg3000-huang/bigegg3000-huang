<h1 align="center">👋 Hi, I'm Huang</h1>
...
I'm a passionate **Coding Master** with over 150 years of experience building super $\Huge{\mathbf{\color{#ff0000}{\rm F}} \mathbf{\color{red}{\it A}} \mathbf{\color{orange}{\mathsf{N}}} \mathbf{\color{gold}{\mathcal{T}}} \mathbf{\color{green}{\mathfrak{A}}} \mathbf{\color{#00ffcc}{\mathbb{S}}} \mathbf{\color{blue}{\rm T}} \mathbf{\color{#0000ff}{\it I}} \mathbf{\color{#8c00ff}{\mathbf{C}}}}$ Software. I focus on performance, clean architecture, and creating smooth user experiences using cutting-edge technologies.  
I enjoy contributing to the tech community through open-source projects and blog posts.
